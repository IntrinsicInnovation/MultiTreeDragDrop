...
(function ($) {
    ...
    $.fn.columnFilter = function (options) {
        ...
        function fnCreateInput(oTable, regex, smart, bIsNumber, width) {
        ...
        function fnCreateColumnSelect(oTable, aData, iColumn, nTh, sLabel, width) {
            if (aData == null)
        ...
        function fnCreateSelect(oTable, aData, width) {
            ...
            fnCreateColumnSelect(oTable, aData, _fnColumnIndex(i), th, label, width); //Issue 37
            ...
            $(sFilterRow + " th", oTable).each(function (index) {
                ...
                if (aoColumn != null) {
                    ...
                    switch (aoColumn.type) {
                        case "number":
                            fnCreateInput(oTable, true, false, true, aoColumn.width);
                            break;

                        case "select":
                            fnCreateSelect(oTable, aoColumn.values, aoColumn.width);
                            break;
                        case "number-range":
                        ...
                        default:
                            ...
                            fnCreateInput(oTable, bRegex, bSmart, false, aoColumn.width);
                            break;
