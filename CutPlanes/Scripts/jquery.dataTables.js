		...
		function _fnBindAction( n, oData, fn )
		{
			$(n)
				.bind( 'click.DT', oData, function (e) {
				        fn(e);
				        // MTM patched as per http://datatables.net/forums/discussion/8932/ie-specific-pagination-bug-description-and-fix-included/p1
...
$.fn.disableTable = function () {   
                                    $("thead > tr:first", $(this)).hide();
                                    $("input", $(".dataTables_filter")).prop("disabled", true);
                                    $("select", $(".dataTables_length")).prop("disabled", true);    
                                };
